...
import DataTrackTable from '../../components/DataTrackTable';
        ...
        <Box sx={{ width: '100%', minHeight: '100vh', marginTop: '2vh' }}>
          ...
          >
            ...
            <Box sx={{ width: '75%', padding: 2 }}>
              <Box sx={{ mb: 2 }}>
                <Button onClick={handleAddAllTracksClick} variant="contained" sx={{ mr: 1, color: 'white'}}>
                  Add All Tracks
                </Button>
                <Button onClick={removeAllTracks} variant="contained" color="secondary" sx={{color: 'white'}}>
                  Remove All Tracks
                </Button>
              </Box>
