...
import { AppBar, Toolbar, Button, Typography, useMediaQuery, Box, IconButton, Theme } from "@mui/material";
    ...
    >
      <Toolbar variant="dense" className={classNames(classes.spaceBetween)}>
        {homepage ? null : (
          ...
          >
            <img width="30px" height="100%" alt="logo" src="/assets/img/vault_mark_logo.svg" />
          </Box>
        )}
        <Box
          sx={{
